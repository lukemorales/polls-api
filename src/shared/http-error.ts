...
class HttpError extends Error {
  ...
  public static TooMunknownRequests(message?: string, errorData?: unknown) {
    return new HttpError(message ?? 'Too Munknown Requests', 429, errorData);
  }
...
export const httpError = new Elysia({
